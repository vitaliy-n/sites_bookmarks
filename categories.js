...
const CAT_TREE = [
    ...
    {
        id: 'papercraft', name: 'Паперкрафт', emoji: '✂️', color: '#8d6e63', sub: 'Моделі з паперу, шаблони, навчання, натхнення',
        children: [
            { id: 'papercraft-learn', name: 'Навчання та туторіали', emoji: '🎬' },
            { id: 'papercraft-templates', name: 'Шаблони та розгортки', emoji: '📐' },
            { id: 'papercraft-shop', name: 'Магазини та набори', emoji: '🛒' },
            { id: 'papercraft-community', name: 'Спільноти та гуртки', emoji: '👥' },
            { id: 'papercraft-inspiration', name: 'Натхнення та галереї', emoji: '💡' },
            { id: 'papercraft-tools', name: 'Інструменти та матеріали', emoji: '🛠️' }
        ]
    },
